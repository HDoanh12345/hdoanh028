...
if (!isset($_SESSION['giohang'])) {
    ...
    if (isset($_GET['action'])&&($_GET['action']!="")) {
        ...
        switch ($action) {
            ...
            //     }
            //      include "views/taikhoan/capnhat.php";             
            //     break;
            // case 'quenmk':
                ...
                if (isset($_POST['dongydat'])&&($_POST['dongydat'])){
                   ...
                   // tao giohang
                    foreach ($_SESSION['giohang'] as $giohang) { 
                        them_giohang($_SESSION['Ten_ND']['ID_ND'],$giohang[0],
                        $giohang[2],$giohang[1],$giohang[3],$giohang[4],$giohang[5],$iddonhang);
                    }
                    //xoa session
                    $_SESSION['giohang']=[];
                }
